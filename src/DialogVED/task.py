...
def test():
    ...
    input_args = [
        ...
        '--dataset-impl', 'mmap',
        # this two parameters are important
        # '--add-cls-to-source',
        # '--mask-source',
        # '--masked-prob', '0.15',
        # '--masked-span-len', '2',
        # '--min-masked-len', '15',
        # '--auto-infer-absolute-positions',
        # '--auto-infer-relative-positions',
    ]
    ...
    # single example
    print(task.datasets['train'][0])

    print(task.datasets['train'][0]['source'])
    print(task.source_dictionary.string(task.datasets['train'][0]['source']))

    # batch
    batch_size = 5
    samples = [task.datasets['train'][_] for _ in range(batch_size)]
    print(task.datasets['train'].collater(samples))
