...
########################################################################################################################
#SUFFIX='_vae_test_tfidf_only_latent'
SUFFIX='_vae_test_tfidf'
...
TFIDF_MODEL_DIR=/mnt/my_outputs/wchen2/tfidf_model
TFIDF_DICT_DIR=/mnt/my_outputs/wchen2/tfidf_dict
...
########################################################################################################################
SUFFIX='_vae_test_tfidf_only_latent_beam1'
BEAM_SIZE=1
CHECK_POINT=${SAVE_DIR}/checkpoint_best.pt
#CHECK_POINT=${SAVE_DIR}/checkpoint5.pt
#TASK=seq2seq_vae
TASK=translation_prophetnet
